...
export const QuickActionsSection: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <Card 
        className="hover:shadow-md transition-shadow cursor-pointer group hover:border-green-500/50"
      ...
      <Card 
        className="hover:shadow-md transition-shadow cursor-pointer group hover:border-purple-500/50"
